...
const mockData: SummaryData = {
    totalDaysLost: 85,
    topAbsenceType: 'Vacaciones Anuales',
    absenteeismRate: 3.5,
};
                ...
                <div className="w-full mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-10">
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-indigo-500">
                            ...
                            <p className="mt-1 text-3xl font-semibold text-gray-900">{mockData.totalDaysLost}</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-sky-500">
                            ...
                            <p className="mt-1 text-3xl font-semibold text-gray-900">{mockData.absenteeismRate}%</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-amber-500">
                            <p className="text-sm font-medium text-gray-500">Tipo de Ausencia Más Común</p>
                            <p className="mt-1 text-lg font-semibold text-gray-900">{mockData.topAbsenceType}</p>
                        </div>
                    </div>
