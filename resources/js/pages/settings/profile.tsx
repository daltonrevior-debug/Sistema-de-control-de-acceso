        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Información del perfil" description="Actualice su nombre, apellido y correo electrónico" />
                        ...
                        {mustVerifyEmail && auth.user.email_verified_at === null && (
                            <div>
                                <p className="text-muted-foreground -mt-4 text-sm">
                                    ...
                                    >
                                        Presiones aqui para reenviar el correo electrónico de verificación.
                                    </Link>
                                </p>
